      ...
      <section className="flex space-x-3 overflow-x-auto no-scrollbar py-2">
        {moods.map((m) => {
          ...
          <motion.button
            ...
            className={`flex-shrink-0 px-4 py-3 rounded-2xl border flex items-center space-x-2 transition-all transform ${isActive
      ...
      <section>
        {todayLook ? (
          ...
          <motion.button
            ...
            className="w-full bg-primary text-white p-5 rounded-3xl shadow-xl shadow-primary/20 flex items-center justify-between group hover:bg-teal-900 transition-all btn-interactive"
          >
            ...
            <div className="bg-[var(--bg-card)]/10 p-2 rounded-full group-hover:bg-[var(--bg-card)]/20 transition-colors">
              <Sparkles size={24} className="text-accent group-hover:rotate-12 transition-transform duration-300" />
            </div>
          </motion.button>
        )}
      </section>
