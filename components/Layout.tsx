            ...
            return item.id === 'wardrobe' ? (
              ...
              >
                <motion.button
                  ...
                  className="w-full h-full flex flex-col items-center justify-center group outline-none gap-1.5 active:scale-95 transition-transform"
                >
                  <div className={`transition-all duration-300 transform ${isActive ? '-translate-y-0.5 scale-110' : 'translate-y-0.5 group-hover:scale-110'}`}>
              ...
              <motion.button
                ...
                className="relative z-10 flex-1 h-full flex flex-col items-center justify-center group outline-none gap-1.5 active:scale-95 transition-transform"
              >
                <div className={`transition-all duration-300 transform ${isActive ? '-translate-y-0.5 scale-110' : 'translate-y-0.5 group-hover:scale-110'}`}>
                  <Icon size={22} strokeWidth={isActive ? 2.5 : 2} className={`transition-colors duration-300 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-primary/70'}`} />
                </div>
